...
<body class="bg-darkBlue font-family-karla h-screen">
    ...
    <div class="w-full flex flex-wrap">
        ...
        <div class="w-full md:w-7/12 flex flex-col">
            <div class="flex flex-col justify-center md:justify-start my-auto pt-8 md:pt-0 px-8 md:px-24 lg:px-32">
                <div class="bg-pewter px-6 py-4 my-8 rounded-xl shadow-md text-black w-full">
                    ...
                    <h1 class="mb-4 text-3xl text-center font-bold">CariGuruPrivat!</h1>
                    <div class="mx-12">
                        <div>
                            <label class="block text-gray-700 text-sm font-bold" for="nama_lengkap">
                                Nama Lengkap
                            </label>
                            <input id="nama_lengkap" type="text" class="block border-4 border-gray-300 outline-none focus:border-gray-700  w-full p-1.5 rounded-2xl mb-2" name="fullname" placeholder="" />
                        </div>
                        <div>
                        ...
                        <!-- <div>
                            ...
                            <input id="confirm_password" type="password" class="block border-4 border-gray-300 outline-none focus:border-gray-700  w-full p-1.5 rounded-2xl mb-2" name="confirm_password" placeholder="" />
                        </div> -->
                        <div class="">
        ...
        <div class="w-5/12 shadow-2xl">
            <img class="object-cover w-full h-screen hidden md:block" src="/img/components/background/bg-daftar.jpg" alt="Background" />
        </div>
    </div>
