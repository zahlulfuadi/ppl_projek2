        ...
        <div x-data="{ open: false }" class="flex flex-col max-w-screen-xl px-4 mx-auto md:items-center md:justify-between md:flex-row md:px-6 lg:px-8">
            ...
            <nav :class="{'flex': open, 'hidden': !open}" class="flex-col-reverse flex-grow pb-4 md:pb-0 hidden md:flex md:justify-between md:flex-row">
                ...
                <div class="flex flex-col items-start md:flex-row md:items-center">
                    ...
                    <a href="/login" class="px-4 py-2 mt-2 text-sm font-semibold bg-transparent md:mt-0 md:ml-4 focus:outline-none  text-gray-700 hover:text-black rounded-md">Masuk</a>
                </div>
                <!-- </div> -->
