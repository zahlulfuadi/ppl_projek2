        ...
        <div x-data="{ open: false }" class="flex flex-col max-w-screen-xl px-4 mx-auto md:items-center md:justify-between md:flex-row md:px-6 lg:px-8">
            ...
            <nav :class="{'flex': open, 'hidden': !open}" class="flex-col-reverse flex-grow pb-4 md:pb-0 hidden md:flex md:justify-between md:flex-row">
                ...
                <div class="flex flex-col items-start md:flex-row md:items-center">
                    ...
                    <a href="/choose-user" class="px-4 py-2 mt-2 text-sm font-semibold bg-transparent md:mt-0 md:ml-4 focus:outline-none  text-gray-700 hover:text-black rounded-md">Masuk</a>
                </div>
                <!-- </div> -->
            ...
            <div class="relative z-10 pb-8 px-4 sm:px-6 lg:px-8 sm:pb-16 md:pb-20 w-full lg:pb-28 xl:pb-32">
                ...
                <div class="text-lg leading-loose font-body font-semibold text-darkBlue sm:text-xl md:text-2xl">
                    ...
                    $subjek = [
                        ...
                        'Sejarah', 'Komputer', 'Design',
                        'Bahasa Indonesia', 'IPA', 'Renang',
                        'Fisika', 'Geografi', 'Geologi',
                        'Bahasa Inggris', 'Olahraga', 'IPS',
                        'Bahasa Jepang', 'Ekonomi', 'Kalkulus',
                        'Bahasa Arab', 'Sosiologi', 'Grammar',
                        'Manajemen', 'Memasak', 'Piano',
                        'Menari', 'Gitar', 'Biola',
                    ];
                    $j = 0;
                    for ($i = 0; $i < count($subjek); $i++) { ?>
