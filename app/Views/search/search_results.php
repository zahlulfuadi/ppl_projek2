...
<div class="grid justify-items-center bg-blueGray">
    <div class="w-full min-h-screen items-center pt-28">
        <div class="w-2/3 justify-self-center mx-auto">
            <form action="#">
                <div class="flex flex-row justify-center mx-auto">
                    <input type="text" class="py-2 pl-2 w-72 text-sm rounded-l-lg focus:outline-" value="Matematika">
        ...
        <div class="flex flex-col mt-16 px-20 bg-blue-400">
        ...
        <div class="container min-h-screen flex justify-center items-center px-4 sm:px-6 lg:px-8 -mt-64">
        </div>
    </div>
</div>
<?= $this->endSection() ?>